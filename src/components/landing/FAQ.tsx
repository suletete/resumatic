...
export function FAQ() {
  ...
  // FAQ data - focused on Resume specific questions
  const faqItems: FAQItem[] = [
    {
      question: "How does resuMatic's AI tailor my resume for specific jobs?",
    ...
    {
      question: "Is resuMatic really free to use?",
    ...
    {
      question: "What makes resuMatic different from other resume builders?",
      answer: "resuMatic is specifically designed for tech professionals with AI-powered optimization, ATS compatibility, and the ability to create multiple tailored versions from one base resume. Plus, it's open-source and can be self-hosted for complete control over your data."
    },
    {
      question: "How long does it take to create a resume with resuMatic?",
    ...
    },
    {
      ...
      answer: "Absolutely! resuMatic is specifically designed to create ATS-optimized resumes. Our templates use proper formatting, keyword optimization, and structure that ATS systems can easily parse and rank highly."
    },
    {
      question: "Can I use my own AI API keys?",
      answer: "Yes! With our free plan, you can use your own OpenAI, Anthropic, or other AI provider API keys. This gives you full control over costs and usage while still accessing all of resuMatic's features."
    },
    {
      question: "Is my data secure and private?",
      answer: "Your privacy is our priority. All data is encrypted, and you can even self-host resuMatic for complete control. We never share your personal information or resume data with third parties."
    },
    {
      question: "Do you offer support for students or career changers?",
      answer: "Absolutely! resuMatic is perfect for students, career changers, and professionals at any level. Our AI helps highlight transferable skills and optimize your resume regardless of your experience level."
    }
  ];
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-2xl mx-auto text-center mb-12">
        ...
        >
          Quick answers to help you get started with Resume
        </motion.p>
      </div>
