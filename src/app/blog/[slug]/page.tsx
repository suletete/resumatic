...
export async function generateMetadata({ params }: BlogPostPageProps): Promise<Metadata> {
  ...
  const url = `https://Resume.com/blog/${slug}`;
          ...
          <script
            ...
            dangerouslySetInnerHTML={{
              __html: JSON.stringify({
                ...
                description: post.frontMatter.description,
                image: 'https://Resume.com/og.webp',
                ...
                publisher: {
                  ...
                  logo: {
                    '@type': 'ImageObject',
                    url: 'https://Resume.com/og.webp',
                  },
                  url: 'https://Resume.com',
                },
                mainEntityOfPage: {
                  '@type': 'WebPage',
                  '@id': `https://Resume.com/blog/${slug}`,
                },
          ...
          <div className="text-center">
            <div className="inline-block p-8 rounded-2xl bg-gradient-to-r from-teal-50 to-cyan-50 border border-teal-100">
              ...
              <p className="text-gray-600 mb-6 max-w-md mx-auto">
                Join thousands of professionals who have already transformed their careers with Resume.
              </p>
