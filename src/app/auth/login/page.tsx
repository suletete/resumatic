...
export const metadata: Metadata = {
  title: "Login | Resumatic- AI-Powered Resume Builder",
  description: "Create tailored, ATS-optimized resumes powered by AI. Resumatic helps you land your dream tech job with personalized resume optimization.",
